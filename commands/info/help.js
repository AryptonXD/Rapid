...
module.exports = {
  ...
  rishi = await client.users.fetch(`864165006668726313`); //arypton
...
~ Support Server: [Rapid HQ](${Settings.bot.credits.supportServer})`)
      .addField(`__Main Modules__`, `<a:security:1055831548101939331> Antinuke
<:ET_boom:1022870815227777044> Moderation
<:automod:1055832658942378044> Automod
<:emoji2:1047037776933163038> Custom Role
<:ray_ticket:1067391528311459840> Ticket
<:icons_tada:1050760987839565854> Giveaway
<:rapid_tag:1098162621217247243> Tag System
<:ET_mod:1022869727145639946> Verification
<:icons_discordhypesquard:1046708051295612978> Vanity Roles
<:jk_mic:1050775463821332560> Invc`, true)
      .addField(`__Extra Modules__`, `<:nsfw:1050775462860824686> Image
<:ET_info:1022870207745757245> Information
<:ET_bug:1022870703718027326> Report
<:rapid_raja:1098161628693925958> Owner
<:emoji_13:1047038076326785074> Games
<:malware_nonSFW:1055832664378179664> Nsfw
<:emoji_2:1047037776933163038> Fun
<:voice:1050775464945397780> Voice
<:emoji_15:1047038141204287529> Utility`, true)
      ...
      new MessageSelectMenu()
        ...
        .addOptions([
          ...
          },
          {
            label: 'Voice',
            value: 'h19',
            emoji: "1050775464945397780",
            description: 'See the Voice Commands'
          },
          {
            label: 'Utility',
            value: 'h20',
            emoji: "1047038141204287529",
    ...
    const pag = new MessageActionRow().addComponents(
      ...
      const pag2 = new MessageActionRow().addComponents(
            ...
            new MessageButton().setStyle(`DANGER`).setCustomId(`logl3`).setEmoji(`1003992348205777036`).setDisabled(true),
