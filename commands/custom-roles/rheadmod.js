...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        let reqRole = await client.db3client.db3.get(`reqrole_${message.guild.id}`);
     ...
     const rajaa = new MessageEmbed()
      ...
      .setFooter(client.user.tag, client.user.displayAvatarURL())
        ...
        if(!args[0]){
            return message.channel.send({embeds : [new MessageEmbed().setColor(`#2f3136`).setDescription(`Usage: ${prefix}rheadmod <user>`)]})
        }
